...
```{r avg_sale_price_borough, fig.width = 8, echo = FALSE}
...
year.borough.price.plot <- ggplot(all.year.price, aes(`Sale Year`, as.integer(`Avg. Price`), color = `Fixed Borough`)) + 
                   ...
                   ggtitle("NYC Avg. Real Estate Price by Borough and Year") + theme_minimal(base_size = 12)
...
```{r avg_sale_price_code, fig.width = 8, echo = FALSE}
...
year.code.price.plot <- ggplot(mean.year.code.price, aes(`Sale Year`, as.integer(`Avg. Price`), color = `Building Class First Letter`)) + 
                   ...
                   ggtitle("NYC Avg.Residential Real Estate Price by Class Code and Year") + theme_minimal(base_size = 12)
